    ...
    return html`
      <div id="carouselExampleAutoplaying" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
          ...
          <div class="carousel-item">
            <img data-src="https://firebasestorage.googleapis.com/v0/b/keris-api.appspot.com/o/images%2Fbanner%2Fbanner-art-3.jpg?alt=media&token=4b5d128b-db2d-4156-a432-81de7cba947b" class="lazyload d-block w-100 rounded" alt="..." />
          </div>
        </div>
