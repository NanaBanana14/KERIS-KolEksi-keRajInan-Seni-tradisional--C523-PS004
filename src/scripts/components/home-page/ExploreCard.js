...
class ExploreCard extends LitWithoutShadowDom {
  ...
  handleCardKeyPress(event, pageId) {
    if (event.key === 'Enter') {
  ...
  render() {
    return html`
      <div class="container d-flex justify-content-center gap-5 flex-wrap">
        <div
          class="card card-explore-first position-relative"
          style="width: 260px"
          @click="${() => this.navigateToPage('/menu/galeri-seni.html')}"
          @keydown="${(e) => this.handleCardKeyPress(e, '/menu/galeri-seni.html')}"
          tabindex="0"
        >
          <img 
        ...
        <div
          class="card card-explore position-relative"
          style="width: 260px"
          @click="${() => this.navigateToPage('/menu/kalendarbudaya.html')}"
          @keydown="${(e) => this.handleCardKeyPress(e, '/menu/kalendarbudaya.html')}"
          tabindex="0"
        >
          <img 
            class="lazyload w-75 position-absolute top-0 start-50 translate-middle"
        ...
        <div
          class="card card-explore position-relative"
          style="width: 260px"
          @click="${() => this.navigateToPage('/menu/news.html')}"
          @keydown="${(e) => this.handleCardKeyPress(e, '/menu/news.html')}"
          tabindex="0"
        >
          <img 
            class="lazyload w-75 position-absolute top-0 start-50 translate-middle"
