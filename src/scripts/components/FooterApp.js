        ...
        <footer class="row row-cols-1 row-cols-sm-2 row-cols-md-5 py-5 my-5 border-top">
          ...
          <div class="col mb-3">
            ...
            <ul class="nav flex-row gap-3 mt-3">
              ...
              <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-white"><i class="bi bi-twitter"></i></a></li>
              <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-white"><i class="bi bi-youtube"></i></a></li>
            </ul>
          </div>
