...
const createEventTemplate = (event) => `
  <div class="card mb-3 col-md-4 position-relative p-0" id="event-${event.id}">
    ...
    <div class="card-body">
      ...
      <a href="#" class="btn btn-brown-white btn-event-detail position-absolute bottom-0 end-0 mb-3 mx-3" data-detail-url=" ${event['detail-url']}">Read more <i class="bi bi-arrow-right-circle-fill"></i></a>
    </div>
  </div>
`;
